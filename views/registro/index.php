                ...
                <div class="col s12 l6">
                    <div class="card">
                        <div class="card-content white-text">
                            ...
                            <br>
                            <a id="btn-registro_academico" class="waves-effect waves-light btn center"><i
                                    class="material-icons left">school</i>Seleccionar</a>
                        </div>
                    </div>
                </div>
                <div class="col s12 l6">
                    <div class="card">
                        <div class="card-content white-text">
                            ...
                            <br>
                            <a id="btn-registro_empresario" class="waves-effect waves-light btn center"><i
                                    class="material-icons left">account_balance</i>Seleccionar</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col s12">
                    ...
                    <form id="registro_academia-form">
                        ...
                        <ul id="stepper-academia" class="stepper horizontal" style="min-height:700px">
                                ...
                                <div class="step-content">
                                    ...
                                    <div style=" border-radius: 30px;" class="row white">
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            ...
                                            <input id="registro_academico-form-input-nombre" name="nombre" type="text"
                                                class="validate" required>
                                            <label for="registro_academico-form-input-nombre">Nombre(s)*</label>
                                        </div>
                                        <div class="input-field col l4 s12">
                                            <input id="registro_academico-form-input-apeidoP" name="apeidoP" type="text"
                                                class="validate" required>
                                            <label for="registro_academico-form-input-apeidoP">Apellido Paterno*</label>
                                        </div>
                                        <div class="input-field col l4 s12">
                                            <input id="registro_academico-form-input-apeidoM" name="apeidoM" type="text"
                                                class="validate" required>
                                        ...
                                        <div class="input-field col l4 s12">
                                            ...
                                            <input id="registro_academico-form-input-email" name="email" type="email"
                                                class="validate" required>
                                            <label for="registro_academico-form-input-email">Correo electrónico*</label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Email válido">No olvide el @</span>
                                        </div>

                                        <!-- Numero de Contacto -->
                                        <div class="input-field col l4 s12">
                                            <i class="material-icons prefix">phone</i>
                                            <input id="registro_academico-form-input-telefono" name="telefono"
                                                type="tel" pattern="[0-9]{10}" class="validate">
                                            <label for="registro_academico-form-input-telefono">Teléfono de
                                                contacto</label>
                                            <span class="helper-text" data-error="Número a 10 dígitos"
                                                data-success="Dato válido">Opcional</span>
                                        </div>

                                        <!-- Fecha de Nacimiento -->
                                        <div class="input-field col l4 s12">
                                            <i class="material-icons prefix">date_range</i>
                                            <input id="registro_academico-form-input-fecha_nacimiento"
                                                name="fecha_nacimiento" type="date" class="validate">
                                            <label for="registro_academico-form-input-fecha_nacimiento">Fecha de
                                                nacimiento </label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Dato válido">Puedes usar el teclado</span>
                                        </div>
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select class="browser-default" id="registro_academico-form-input-estado"
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select class="browser-default" id="registro_academico-form-input-municipio"
                                        ...
                                        <div class="input-field col l6 s12">
                                            ...
                                            <input
                                                pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
                                                title="Mín. 8 caracteres, usa mayúsculas, minúsculas números/caracteres especiales"
                                                id="registro_academico-form-input-pass" name="pass" type="text"
                                                class="validate" required>
                                            <label for="registro_academico-form-input-pass">Contraseña</label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Dato válido">Mín. 8 caracteres, usa mayúsculas, minúsculas
                                                números/caracteres especiales</span>
                                        </div>

                                        <div class="input-field col l6 s12">
                                            <i class="material-icons prefix">lock</i>
                                            <input id="registro_academico-form-input-pass2" name="pass2" type="text"
                                                required>
                            ...
                            <li class="step">
                                <div data-step-label="~3min" class="step-title waves-effect">Institución</div>
                                <div class="step-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="white-text negritas">Estos datos nos ayudarán a conocer tu formación
                                            académica y campo del conocimiento.</p>
                                    </div>
                                    ...
                                    <div style=" border-radius: 30px;" class="row  white">
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select required class="browser-default"
                                                id="registro_academico-form-input-grado_academico"
                                        ...
                                        <div class="input-field col l6 s12">
                                            ...
                                            <input id="registro_academico-form-input-titulo" name="titulo" type="text"
                                                class="validate">
                                            <label for="registro_academico-form-input-titulo">Cargo en la
                                                institución</label>
                                        </div>

                                        <!-- <div class="input-field col s12">
                                            <i class="material-icons prefix">account_balance</i>
                                            <input id="registro_academico-form-input-escuela" name="escuela" type="text"
                                                class="validate" required>
                                            <label for="registro_academico-form-input-escuela">Institución a la que
                                                pertenece*</label>
                                        </div> -->
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select class="browser-default"
                                                id="registro_academico-form-input-tipo-institucion"
                                                name="tipoInstitucion" required>
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            <div>
                                                <label>Seleccione una institución* </label>
                                            </div>
                                            <select class="browser-default"
                                                id="registro_academico-form-input-institucion" name="escuela"
                                                required>
                                            </select>
                                        </div>

                                        <!-- Función en la actual organización -->
                                        <div class="input-field col l6 s12 ">
                                            <div>
                                                <label>Función en la actual organización*</label>
                                            </div>
                                            <select required class="browser-default"
                                                id="registro_academico-form-input-funcion" name="funcion">
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <p class="negritas center">¿En qué campo del conocimiento se desempeña
                                                    actualmente?</p>
                                            </div>
                                            ...
                                            <div id="div-campo_de_conocimiento" class="input-field col l4 s12">
                                                ...
                                                <select class="browser-default" id="campo_de_conocimiento"
                                                    name="campo_de_conocimiento" required>
                                            ...
                                            <div id="div-disciplina" class="input-field col l4 s12">
                                                ...
                                                <select required class="browser-default" id="disciplina"
                                                    name="disciplina">
                                                </select>
                                            </div>
                                            ...
                                            <div id="div-subdisciplina" class="input-field col l4 s12">
                                                ...
                                                <select required class="browser-default" id="subdisciplina"
                                                    name="subdisciplina">
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-field col l4 s12">
                                            ...
                                            <select class="browser-default"
                                                id="registro_academico-form-input-actualmente_estudiando"
                                                name="actualmente_estudiando" required>
                                                <option value="" disabled selected>Seleccione una opción</option>
                                        ...
                                        <div class="input-field col l4 s12">
                                            <input id="registro_academico-form-input-fecha_egreso" name="fecha_egreso"
                                                type="date" class="validate">
                                            <label for="registro_academico-form-input-fecha_egreso">Fecha tentativa de
                                                egreso</label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Dato válido">Puedes usar el teclado</span>
                                        </div>
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            ...
                                            <select class="browser-default" id="registro_academico-form-input-estimulo"
                                                name="estimulo" required>
                                                <option value="" disabled selected>Seleccione una opción</option>
                            ...
                            <li class="step">
                                ...
                                <div class="step-content">
                                    ...
                                    <div class="row white-text">
                                        <p class="negritas">Ahora por favor cuéntamos de tu experiencia y tus objetivos
                                    ...
                                    <div style=" border-radius: 30px;" class="row  white">
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select required class="browser-default"
                                                id="registro_academico-form-input-organizacion_actual"
                                                name="organizacion_actual">
                                                <option value="" disabled selected>Seleccione una opción</option>
                                        ...
                                        <div class="input-field col l6 s12">
                                            <select data-last_valid_selection="" data-max=2
                                                id="registro_academico-form-input-actividad" name="actividad[]" multiple
                                                required>
                                            ...
                                            <label>¿En qué actividad consideras que tienes tu mayor experiencia?
                                                *<sup>1</sup></label>
                                        </div>

                                        <div class="input-field col l6 s12">
                                            <select data-last_valid_selection="" data-max=2 multiple
                                                id="registro_academico-form-input-donde" name="donde[]" required>
                                        ...
                                        <div class="input-field col l6 s12">
                                            <select required data-last_valid_selection="" data-max=2 multiple
                                                id="registro_academico-form-input-desarrollo_talentos"
                                                name="desarrollo_talentos[]">
                                            ...
                                            <label>¿En qué actividad te gustaría desarrollar tus talentos?
                                                *<sup>1</sup></label>
                                        </div>

                                        <div class="input-field col l6 s12">
                                            <select required data-last_valid_selection="" data-max=2 multiple
                                                id="registro_academico-form-input-desarrollo_profecional"
                                                name="desarrollo_profecional[]">
                                                <option value="" disabled>Selecciona</option>
                                            ...
                                            <label>¿En qué tipo de organización te gustaría desarrollarte
                                                profesionalmente? *<sup>1</sup></label>
                                        </div>

                                    </div>
                                    <div class="row">
                                        <p class="white-text negritas">* Datos obligatorios <br> <sup>1</sup> Elegir
                                            máximo 2 opciones </p>
                                        <div class="col s12 right-align">
                                            <button class="waves-effect waves-dark btn next-step">Siguiente</button>
                                        </div>
                            ...
                            <li class="step">
                                ...
                                <div class="step-content">
                                    <!-- Your step content goes here (like inputs or so) -->
                                    <div class="row white-text">
                                        <p class="negritas">Finalmente, cuéntanos qué habilidades o competencias
                                            destacables consideras que has desarrollado hasta ahora.</p>
                                    </div>
                                    <div style=" border-radius: 30px;" class="row  white">

                                        <div class="col l4 s12">
                                            <p>¿Qué tipo de habilidades has desarrollado en tu trayectoria? Elegir máx.
                                                3</p>
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="1" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                                    <span>Generar y aplicar nuevos conocimientos</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="2" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="3" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="4" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="5" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="6" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="7" name="habilidades_experiencia[]"
                                                        class="habilidades_experiencia" />
                                        ...
                                        <div class="col l4 s12">
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="1" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="2" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="3" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="4" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="5" name="habilidades[]"
                                                        class="habilidades" />
                                                    <span>Planeación y logística de eventos académicos y/o
                                                        empresariales</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="6" name="habilidades[]"
                                                        class="habilidades" />
                                                    <span>Comunicación oral y escrita de contenidos técnicos o
                                                        financieros</span>
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="7" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="8" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="9" name="habilidades[]"
                                                        class="habilidades" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="10" name="habilidades[]"
                                                        class="habilidades" />
                                                    <span>Experiencia en proyectos sociales, culturales o
                                                        ambientales</span>
                                                </label>
                                            </p>
                                        </div>
                                        <div class="col l4 s12">
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="1" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="2" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="3" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="4" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="5" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="6" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="7" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="8" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="9" name="competencias[]"
                                                        class="competencias" />
                                            ...
                                            <p>
                                                <label>
                                                    <input type="checkbox" value="10" name="competencias[]"
                                                        class="competencias" />
                                                    <span>Experiencia en propiedad intelectual y transferencia de
                                                        tecnología</span>
                                                </label>
                                            </p>
                                        </div>
                                        ...
                                        <div class="col s12 right-align">
                                            <button id="registro_academico-form-btn-submit"
                            ...
                            <li class="step active">
                                ...
                                <div class="step-content">
                                    ...
                                    <div style=" border-radius: 30px;" class="row white black-text">
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            <i class="material-icons prefix">account_circle</i>
                                            <input id="registro_empresario-form-input-nombre" name="nombre" type="text"
                                                class="validate" required>
                                            <label for="registro_empresario-form-input-nombre">Nombre(s)*</label>
                                        </div>
                                        <div class="input-field col l4 s12">
                                            <input id="registro_empresario-form-input-apeidoP" name="apeidoP"
                                                type="text" class="validate" required>
                                            <label for="registro_empresario-form-input-apeidoP">Apellido
                                                Paterno*</label>
                                        </div>
                                        <div class="input-field col l4 s12">
                                            <input id="registro_empresario-form-input-apeidoM" name="apeidoM"
                                                type="text" class="validate" required>
                                            <label for="registro_empresario-form-input-apeidoM">Apellido
                                                Materno*</label>
                                        </div>
                                        ...
                                        <div class="input-field col l4 s12">
                                            <i class="material-icons prefix">alternate_email</i>
                                            <input id="registro_empresario-form-input-email" name="email" type="email"
                                                class="validate" required>
                                            <label for="registro_empresario-form-input-email">Correo
                                                electrónico*</label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Email válido">No olvide el @</span>
                                        </div>
                                        ...
                                        <div class="input-field col l4 s12">
                                            <i class="material-icons prefix">phone</i>
                                            <input id="registro_empresario-form-input-telefono" name="telefono"
                                                type="tel" pattern="[0-9]{10}" class="validate">
                                            <label for="registro_empresario-form-input-telefono">Teléfono de
                                                contacto</label>
                                            <span class="helper-text" data-error="Número a 10 digitos"
                                                data-success="Dato válido">Opcional</span>
                                        </div>
                                        ...
                                        <div class="input-field col l4 s12">
                                            <i class="material-icons prefix">date_range</i>
                                            <input id="registro_empresario-form-input-fecha_nacimiento"
                                                name="fecha_nacimiento" type="date" class="validate">
                                            <label for="registro_empresario-form-input-fecha_nacimiento">Fecha de
                                                nacimiento </label>
                                            <span class="helper-text" data-error="Dato no válido"
                                                data-success="Dato válido">Puedes usar el teclado</span>
                                        </div>
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select class="browser-default" id="registro_empresario-form-input-estado"
                                                name="estado" required>
                                                <option value="" disabled selected>Seleccione un estado</option>
                                                <option value="1">Option 1</option>
                                                <option value="2">Option 2</option>
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <select class="browser-default"
                                                id="registro_empresario-form-input-municipio" name="municipio" required>
                                                <option value="" disabled selected>Seleccione un municipio</option>
                                                <option value="1">Option 1</option>
                                                <option value="2">Option 2</option>
                                                <option value="3">Option 3</option>
                                        ...
                                        <div class="input-field col l6 s12">
                                            ...
                                            <input
                                                pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
                                                title="Mín. 8 caracteres, usa mayúsculas, minúsculas números/caracteres especiales"
                                                id="registro_empresario-form-input-pass" name="pass" type="text"
                                                class="validate" required>
                                            <label for="registro_empresario-form-input-pass">Contraseña</label>
                                            <span class="helper-text"
                                                data-error="Mín. 8 caracteres, usa mayúsculas, minúsculas números/caracteres especiales"
                                                data-success="Dato válido">Mín. 8 caracteres, usa mayúsculas, minúsculas
                                                números/caracteres especiales</span>
                                        </div>
                                        ...
                                        <div class="input-field col l6 s12">
                                            <i class="material-icons prefix">lock</i>
                                            <input id="registro_empresario-form-input-pass2" name="pass2" type="text"
                                                required>
                                ...
                                <div class="step-content">
                                    ...
                                    <div style=" border-radius: 30px;" class="row  white black-text">
                                        ...
                                        <div class="input-field col l6 s12 ">
                                            ...
                                            <input id="registro_empresario-form-input-nombre_empresa"
                                                name="nombre_empresa" type="text" class="validate" required>
                                            <label for="registro_empresario-form-input-nombre_empresa">*Nombre de la
                                                empresa</label>
                                        </div>

                                        <div class="input-field col l6 s12">
                                            <i class="material-icons prefix">http</i>
                                            <input id="registro_empresario-form-input-pagina_web" name="pagina_web"
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            ...
                                            <select id="registro_empresario-form-input-puesto" name="puesto"
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            <div>
                                                <label>*Tamaño de la empresa</label><sup><a
                                                        href="#modal-mensaje">?</a></sup>
                                            </div>
                                            <select id="registro_empresario-form-input-tamano" name="tamano"
                                                class="browser-default" required>
                                        ...
                                        <div class="input-field col l4 s12 ">
                                            ...
                                            <select id="registro_empresario-form-input-mercado" name="mercado"
                                                class="browser-default" required>
                                                <option value="" disabled selected>Seleccione una opción</option>
                                    ...
                                    <div class="step-actions">
                                        <button id="registro_empresario-form-btn-submit"
                                            class="btn waves-effect waves-light" type="submit" name="action">Enviar
                                            <i class="material-icons right">send</i>
                                        </button>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12">
                    ...
                    <h4 class="negritas">A continuación, ingresa al PACT para realizar alguna de las siguientes
                        acciones:</h4>
                </div>
            </div>
            <div class="row" id="recomendaciones_academico">
                <div class="col s12">
                    <ul class="collection">
                        <li class="collection-item">Registrar y consultar instituciones educativas y de investigación,
                            así como sus capacidades en ciencia, ingeniería y humanidades.</li>
            ...
            <div class="row">
                <div class="col s12 right-align">
                    <a href="login" class="waves-effect waves-light btn"><i
                            class="material-icons right">input</i>Acceder</a>
                </div>
            </div>
        </div>
    </div>

    <?php require 'views/include_views/templates/footer.php'; ?>
