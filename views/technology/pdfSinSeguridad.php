...
if($this->nivel['nivel']==0){
	...
	darFormatoTexto('Entonces es posible afirma que la tecnología que se evalúa en este proyecto se encuentra en su etapa de "'.$etapaCicloVida.'". Esto corrobora la premisa de los niveles TRL, puesto que a mayor nivel TRL mayor facilidad de adopción de la tecnología, integración con otros sistemas, comercialización del producto y por último la utilidad del producto para el mercado.
	');
	$pdf-> ln(84);
}
//-----------Sección 3---------------
...
//introducción TPL 1
darFormatoTexto("El nivel de rendimiento de una tecnología esta ampliamente relacionado con la viabilidad comercial de la misma y se puede medir en cada uno de los niveles TRL. La ruta de aceleración comercial indica el avance de una tecnología en sus diversas etapas y como este avance le permitirá en el corto o largo plazo convertirse en una tecnología viable comercialmente hablando.
...
imagestringup($img, 5 , 30 , 400 , utf8_decode('RENDIMIENTO DE LA TECNOLOGÍA'), $blueTBR); //vertical
...
//origen
imagefilledarc($img, $origenX, $origenY, $diametroRelleno, $diametroRelleno, 0, 360, $blue,IMG_ARC_EDGED);
imagearc($img, $origenX, $origenY, $diametroBase, $diametroBase, 0, 360, $green);
