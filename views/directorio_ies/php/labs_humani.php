        ...
        <div class="section wrapper">
            <section id="labsHumani">
                ...
                //CONSULTA
                    ...
                    WHERE ul.fk_institucion = '$id_humani' LIMIT 1");
                ...
                ?>
                        <h5 class="texto-marino">Capacidades de investigación humanística.</h5>
            ...
            <section id="labsHumani" class="lab_table">
                     <table class="table sticky">
                        ...
                        <tbody>
                            <?php 
                                ...
                                WHERE id_institucion = '$id_humani' AND id_ambito = 3");
