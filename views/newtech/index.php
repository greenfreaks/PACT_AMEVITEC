...
<html>
  <head>
    ...
    <title>PACT - Nueva tecnología</title>
  </head>
    ...
    <div class="navbar-fixed">
        <nav>
            <div class="nav-wrapper container">
                <a class="brand-logo center">Nueva Tecnología.</a>
                ...
                <div class='step-content box-shadow'>
                  ...
                  <div class="row">
                    <div class="col s12 black-text">
                        <h5 class="center texto-verde bold" >¿Cuáles son las industrias que se pueden beneficiar de tu tecnología?</h5>
                        <p>Selecciona el sector industrial en donde piensas explotar tu tecnología o proyecto para lanzar innovaciones al mercado.</p>
                        <p>Selecciona sector, subsector, rama y da clic en el botón verde para agregar. <b class="texto-marino">Puedes seleccionar hasta 3 sectores industriales </b> con su rama.</p>
                    </div>
                    ...
                    <div class="col l1 s12 center">
                      <a id='btn-seleccionar-rama' class='btn-floating btn-large waves-effect waves-light btn green'><i class='material-icons left'>add</i>Seleccionar.</a>
                    </div>
                ...
                <div class='step-content'>
                  ...
                  <div class="row">
                    <div class="col s12">
                      ...
                      <p>Te ayudaremos a describir la solución que aporta tu tecnología. Usa los campos de selección y <b class="texto-marino">escribe en máx. 300 caracteres </b> la solución o problemática que resuelve.</p>
                      ...
                      <p>Ejemplo: Mi <u>proceso o método</u> va dirigido a <u>empresas</u> y <u>reduce</u> <u>las emisiones contaminantes que dañan la salud de los habitantes de la Ciudad de México</u>.</p>
                    </div>
                  </div>
                  <div class="row gris-claro">
                    ...
                    <div class="col l3 s12 center">
                      <br>
                      <a id='btn-agregar-predicado' class='waves-effect waves-light btn green'><i class='material-icons left'>add</i>Agregar</a>
                      <br>
                    </div>
              ...
              <li class='step'>
                ...
                <div class='step-content'>
                  ...
                  <div class="row center">
                    <h5 class="texto-verde bold">¿A qué Objetivos de Desarrollo Sostenible de la ONU contribuye tu proyecto?</h5>
                    <p>Puedes seleccionar los Objetivos de Desarrollo Sostenible más importantes de tu proyecto (máx. 3).</p>
                    <sub><a target="_blank" href="https://www.un.org/sustainabledevelopment/es/2018/08/sabes-cuales-son-los-17-objetivos-de-desarrollo-sostenible">¿Cúales son los Objetivos de Desarrollo Sostenible de la ONU?</a></sub><br>
                  </div>
