...
<body>
    ...
    <section class= "center" style = "margin-top: 50px;">
        ...
        <h6 class = "texto-negro" style = "margin-top: 20px;">Te damos la bienvenida a la <b class = "texto-rosa">Plataforma de Aceleración Comercial de Tecnologías, </b> <br>en esta página podrás registrarte para ser parte de
        nuestra base de académicos y empresarios en busca de alianzas para la innovación <b class = "texto-marino bold">¡Participa!</b></h6>
    </section>
                        ...
                        <div class="card-content">
                            ...
                            <form id="login-form">
                                <div class="row center">
                                    ...
                                    <div class="input-field col s12">
                                        <input id="login-form-input-password" name="pass" type="password" class="validate">
                                        <label for="login-form-input-password">Contraseña</label>
                                    </div>
                                    <div class="col s6">
                                        <a id="btn-registro" href="registro" class="btn round-corners"><i class="material-icons left">add</i>Registrarse</a>
                                    </div>

                                    <div class="col s6 ">
                                        <button id="login-form-btn-submit" class="btn round-corners" type="submit" name="action">Ingresar
