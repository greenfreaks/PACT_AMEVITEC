    ...
    <div class="navbar-fixed">
        ...
        <div class="content_container">
            ...
            <section class="center btns">
                <a href="buscador_talentos" id="submit_wp" class="btn">Enviar mensaje de WhatsApp</a>
                <a class="btn" href="buscador_talentos">Regresar</a>
            </section>
        ...
        <script src = "public/js/msj_wp.js"></script>
