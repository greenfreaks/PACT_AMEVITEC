document.querySelector('#submit_wp').addEventListener('click',function(){
	...
	let	url = "https://api.whatsapp.com/send?phone=527797966790&text=¿Qué tal? Quisiera solicitar más información acerca del talento que tiene los siguientes datos: *%0A%0A* ID del usuario: *"+ id +"* *%0A* Grado: *"+ grado +"*  *%0A* Título: *"+ titulo +"* *%0A* Escuela: *"+ escuela +"* *%0A* Organización: *"+ organizacion +"* *%0A* Función: *"+ funcion +"* *%0A* Campo: *"+ campo +"* *%0A* Disciplina: *"+ disciplina +"* *%0A* Subdisciplina: *"+ subdisciplina +"* ";
